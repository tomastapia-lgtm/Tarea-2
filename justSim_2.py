...
SECUENCIA = [
    ...
    # --- Primer cubo ---
    {"desc": "-", "pose": [-90, 0, 0, 0, 0, 0, 0.000]},
    {"desc": "-", "pose": [-90, -35, -33, 0, -7, 0, 0.000]},
    {"desc": "-", "pose": [-90, -35, -33, 0, -7, 0, 0.020]},
    {"desc": "-", "pose": [-90, 0 , 0, 0, 0, 0, 0.020]},
    {"desc": "-", "pose": [0, -43, -23, -6, 12, 3, 0.020]},
    {"desc": " -", "pose": [0, -43, -23, -6, 12, 3, 0.000]},
    {"desc": " -", "pose": [0, 0, 0, 0, 0, 0, 0.000]},

   # --- Segundo cubo ---
   #{"desc": " 7.1 Abrir Gripper! (Pick)", "pose": [-71, -36, -26, 2, -18, 16, 0.000]}, -> Posicion final del segundo cubo
   {"desc": "-", "pose": [-71, -36, 0, 2, 0, 16, 0.000]},
   {"desc": "-", "pose": [-71, -36, -26, 2, 0, 16, 0.000]},
   {"desc": "-", "pose": [-71, -36, -26, 2, 0, 16, 0.020]},
   {"desc": "-", "pose": [-71, -36 , 0, 2, -18, 16, 0.020]},
   {"desc": "-", "pose": [-71, -36 , 26.2, 2, -18, 16, 0.020]},
   {"desc": "-", "pose": [0, 0, 0, 0, 0, 0, 0.020]},
   {"desc": "-", "pose": [0, -40, -20, -6, 12, 3, 0.020]},
   {"desc": "-", "pose": [-8.4, -42.1, -7.9, 39.6, -9, 0, 0.000]},
   {"desc": "-", "pose": [0, 30, 0 , 0, 0, 0, 0.000]},
]
...
emergency_lbl = ttk.Label(root, text="[ Press 'L' at any time to EMERGENCY STOP ]", font=("Arial", 10, "bold"), foreground="#FF3333")
...
def comenzar_rutina():
    ...
    parada_emergencia = False
    emergency_lbl.config(text="[ Press 'L' at any time to EMERGENCY STOP ]", foreground="#FF3333")
...
def activar_parada_emergencia(event=None):
    ...
    status_lbl.config(text="STATUS: !!! EMERGENCY STOPPED !!!", foreground="#FF0000")
    emergency_lbl.config(text="[ EMERGENCY ACTIVE - Reset routine to unlock ]", foreground="#FFAA00")
